...
function exportToCSV(appointments: AppointmentRow[], professionals: Professional[], periodLabel: string) {
  const headers = [
    ...
    "Precio", "Estado", "Método de Pago", "Comisión (%)", "Comisión ($)"
  ];
...
export default function Salarios() {
  ...
  const totalPayroll = staffPayroll.reduce((s, e) => s + e.commissionEarned, 0);
  ...
  return (
    ...
    >
      ...
      <div className="bg-card border border-border rounded-sm overflow-hidden">
        {/* Table header */}
        <div className="px-4 py-3 border-b border-border/40 bg-muted/20 grid grid-cols-[auto_1fr_auto_auto_auto_auto_auto] gap-4 items-center">
          <div />
        ...
        {loading ? (
          ...
          staffPayroll.map((emp, i) => (
            <motion.div
              ...
              className="grid grid-cols-[auto_1fr_auto_auto_auto_auto_auto] gap-4 items-center px-4 py-3.5 border-b border-border/20 last:border-0 hover:bg-accent/5 transition-colors"
            >
              <div
              ...
              <div>
                <span className="text-xs font-semibold text-primary">
                  ${emp.commissionEarned.toLocaleString("es-AR")}
                </span>
              </div>
            </motion.div>
          ))
        ...
        {!loading && staffPayroll.length > 0 && (
          <div className="grid grid-cols-[auto_1fr_auto_auto_auto_auto_auto] gap-4 items-center px-4 py-3 bg-primary/5 border-t border-primary/20">
            <div />
